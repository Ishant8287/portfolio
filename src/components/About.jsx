        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div ref={ref} className={`fade-up ${inView ? "visible" : ""}`}>
            <p className="font-body text-white/60 text-base md:text-lg leading-relaxed mb-6">
              I'm Ishant Singh — a backend-focused full stack developer pursuing
              B.Tech in CS at JSS Academy of Technical Education, Noida
              (2023–2027).
            </p>
            <p className="font-body text-white/60 text-base md:text-lg leading-relaxed mb-6">
              I build production-ready APIs, multi-tenant systems, and
              AI-integrated applications. My focus is backend depth — clean
              architecture, optimized queries, and systems that actually scale.
              I don't just ship features; I care about what happens under the
              hood.
            </p>
            <p className="font-body text-white/60 text-base md:text-lg leading-relaxed mb-10">
              Currently looking for backend/full stack internships where I can
              contribute real work — not just fix typos and run tests.
            </p>
          ...
          >
            {stats.map((stat, i) => (
              <div
                key={stat.label}
                className="bg-dark p-8 group hover:bg-white/[0.03] transition-colors duration-300 flex flex-col items-center justify-center text-center"
              >
                <p
                  className="font-display text-accent leading-none mb-3 group-hover:scale-105 transition-transform duration-300 origin-center"
